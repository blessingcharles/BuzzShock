...
def buzzShockArgs() -> tuple:
    ...
    parser.add_argument("-t" , "--threads" ,dest="threads" , default=8 , type=int , help="specify the number of threads")


    args = parser.parse_args()

    return (args.endpoint, args.protocol, args.engines_list,
            args.plugins_list, args.output_dir,args.threads ,args.verbose)
